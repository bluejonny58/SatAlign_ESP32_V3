...
float rfGetSignalNorm() {
  ...
  // Die gemeinsame RF-Bewertung wird auf den normalen Prozentbereich
  // 0..100 % begrenzt. Werte oberhalb der starken Referenz werden daher
  // als 100 % dargestellt. Da die Begrenzung zentral hier erfolgt, verwenden
  // TFT, Web-UI, Diagnose und AUTO-Logik weiterhin exakt dieselbe normierte
  // Signalstaerke. Die AUTO-Kandidatenschwelle von 80 % bleibt unveraendert.
